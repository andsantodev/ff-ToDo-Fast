...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    toDoFastAuthUserSubject.add(
      ToDoFastAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<ToDoFastAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  ToDoFastAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = ToDoFastAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    toDoFastAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
